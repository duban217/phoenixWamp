...
<?php include('src/header.php')?>
    ...
    <div class="parag" style=" color:rgb(54, 52, 53);
    font-weight: 100;
    margin:40px 20px;
    font-size:18px;
    line-height:38px;
    ...
    justify-content: center;">
      <p>
        Bienvenue à l'élevage de l'Orée du Bois Blanc, élevage de Berger Blanc Suisse à poils longs depuis 2017.
        Nous sommes situés dans les Landes, à 15 min de Dax, 50 min de Pau, 1h de Bayonne et 2h de Bordeaux.
        <br><br>
        Nous élevons les chiots en famille.
        <br>
        Nous leur apportons toute la sociabilisation qui convient, dès leur plus jeune âge et jusqu'au départ
        de la maison, à leur neuvième semaine.
        <br><br>
        Les chiens et les chiots vivent dans un grand espace qui leur permet de se défouler à loisir. Les adultes pratiquent le canicross dans la campagne environnante et font de nombreuses balades. 
        <br><br>
        Les chiens sont nourris principalement à la viande et au poisson.
    </p>
      </div>
